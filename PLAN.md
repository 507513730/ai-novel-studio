...
> **进度（2026-08-29）**：R0 基线 + R1 章节生成域重放 + R2 job 域隔离已完成（分支 `codex/refactor-r0-r1`，基线文档见 `docs/superpowers/audits/2026-08-29-refactor-baseline.md`，决策 D111/D112）；R0+R1 已合并 main；R2 待合并后继续 R3+。
