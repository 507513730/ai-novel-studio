...
| v0.15-v0.22 版本线 | ✅ | 创作约束 / 自更新 + CNY / 审查修复批 ×3 / 联网查找 / 续写 + 字数分离 / NovelClaw 记忆面 / N1 字数覆盖语义 + ALOW 统一 |
| 测试 | ✅ | vitest 148/148、db-smoke 7/7、typecheck/lint 0 error、e2e R3 52/52 |
