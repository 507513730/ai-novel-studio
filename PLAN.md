...
| B 结构性 | B1 ✅（词条触发注入 + 相似度检索并存，D124）· B2 ✅（已写片段检索地基 getPriorChapterRetrieval，D124；完整 few-shot 注入后续）· B3 存量书稿接续创作 · B4 网文要素生成器集 · B5 伏笔看板+角色关系图（伏笔看板已落地，关系图待回灌关系提取）· B6 故事板 AI 诊断 · B7 系列书共享圣经 |
