...
| **UI 全面升级（1.0 收官批）** | 🚧 | 批次 A（v0.26.0）：UI 一致性与 P0 硬伤修复（docs/ui-review.md）；批次 B（v1.0.0）：观感升级收官——书架/执行页/引导收敛/Hub 升级 |
