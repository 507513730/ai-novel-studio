...
> **进度（2026-08-29）**：R0 基线 + R1 章节生成域重放 + R2 job 域隔离已合并 main（决策 D111/D112）；R3（D113）、R4.1 章节级 generation_token（D114）、R4.2 导演域 + R4.3 整本生产域拆分（D115）已完成并合并 main；下一批 R5 服务端路由与统一错误模型；基线文档见 `docs/superpowers/audits/2026-08-29-refactor-baseline.md`。
