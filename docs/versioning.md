...
| 0.26.0 | UI 一致性与 P0 硬伤修复批（docs/ui-review.md P0/P1：栅格归位 / token 化 / 按钮 nowrap / 侧栏 active 修复 / 三态统一） | 待发布 |
| 1.0.0 | 稳定承诺（判据见 §1.1 二次修订）：UI 全面升级收官 + 核心链稳定 + 数据格式冻结（写书在 1.x 收官） | UI 升级批次完成后 |
