...
- [章节写作页设计与验收（2026-09-12）](development/chapter-workspace-2026-09-12.md)：三栏布局、AI 预览、保存保护及候选包验证记录（D145）。

- [全仓初筛与首批恢复加固（2026-09-11）](review-2026-09-11.md)：10 项代码发现、文档事实纠偏与待确认的硬规范修订提案；专项修复状态独立记录。

- 2026-09-07 依赖审查（D141）：qs 安全覆盖与回归测试；尚未发布，不代表 v1.1.2 安装包已包含修复。

- [流程与文档审查结论](process-review-2026-09-05.md)：已确认问题、已修复机制及待用户裁定的硬约束文字。

- [发布工作流与证据](development/release-workflow.md)：状态分层、指定 SHA 门禁、失败处理与本次流程复盘。

- [全仓审查与重构进度（2026-09-05）](review-2026-09-05.md)：首批 IPC/导航修复、发布 E2E 阻塞、下一批备份协议与验证状态。
